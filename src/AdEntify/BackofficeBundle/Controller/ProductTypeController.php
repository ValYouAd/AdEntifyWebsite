...
use AdEntify\BackofficeBundle\Form\ProductTypeType;
use Symfony\Component\HttpFoundation\Request;
use Symfony\Bundle\FrameworkBundle\Controller\Controller;
use Sensio\Bundle\FrameworkExtraBundle\Configuration\Method;
use Sensio\Bundle\FrameworkExtraBundle\Configuration\Route;
use Sensio\Bundle\FrameworkExtraBundle\Configuration\Template;
use AdEntify\CoreBundle\Entity\ProductType;
...
class ProductTypeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AdEntifyCoreBundle:ProductType')->findAll();
     ...
     *
     * @Route("/", name="producttype_create")
     * @Method("POST")
     * @Template("AdEntifyCoreBundle:ProductType:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AdEntifyCoreBundle:ProductType')->find($id);
    ...
    */
     ...
     *
     * @Route("/{id}", name="producttype_update")
     * @Method("PUT")
     * @Template("AdEntifyCoreBundle:ProductType:edit.html.twig")
     */
